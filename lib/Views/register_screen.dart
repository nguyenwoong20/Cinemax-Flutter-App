...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _loginWithGoogle() async {
    ...
    try {
      ...
      debugPrint('Register GoogleSignIn - idToken: ${idToken != null}');
      debugPrint('Register GoogleSignIn - accessToken: ${accessToken != null}');
      debugPrint('Register GoogleSignIn - serverAuthCode: ${serverAuthCode != null}');
      ...
      if (response.success) {
        ...
        setState(() => _errorMessage = response.message ?? 'Đăng nhập Google thất bại');
      }
    } catch (e, st) {
      debugPrint('Register Google sign-in exception: $e');
      debugPrint('$st');
